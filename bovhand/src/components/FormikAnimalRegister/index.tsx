...
const reviewSchema = yup.object({
  ...
  gender: yup.string().required("Por favor, informe o genero do animal"),
  origin: yup.string().required("Por favor, informe a origem do animal"),
});
        ...
        {(formikProps) => (
          <KeyboardAwareScrollView style={styles.scroll}>
            ...
            <Picker
              style={styles.picker}
              mode="dropdown"
              selectedValue={formikProps.values.origin}
              onValueChange={(itemValue) =>
                formikProps.setFieldValue("origin", itemValue)
              }
            >
              <Picker.Item label="Selecione uma origem" value={initialState.origin}/>
              <Picker.Item label="Compra" value="compra"/>
              <Picker.Item label="Nascimento" value="nascimento"/>
            </Picker>
            <Text style={styles.errorText}>{formikProps.errors.origin}</Text>
            <View>
            {invisibleDate == formikProps.values.origin ? 
            <View>
            ...
            <View>
            {invisiblePrice == formikProps.values.origin ? 
            <View>
