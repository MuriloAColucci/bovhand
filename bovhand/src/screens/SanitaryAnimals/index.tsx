...
export function SanitaryAnimals(){
    const navigation = useNavigation();
    const { getAnimal, listAnimals, animalsList} = useAnimal()


    function handleAboutVaccines(id: number) {
        getAnimal(id)
        navigation.navigate('RegisterVaccines')
    }
    ...
    const renderItem = ({ item } : any) => (
        <RectButton style={styles.buttonAnimal}  onPress={()=>handleAboutVaccines(item.id)}>
